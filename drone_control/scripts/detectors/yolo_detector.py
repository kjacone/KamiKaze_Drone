...
from drone_control.msg import NodeHealth, Command, CommandResponse
...
class YOLODetector:
    ...
    def __init__(self):
        ...
        # Mission integration
        self.mission_sub = rospy.Subscriber('/mission_status', String, self._handle_mission_status)
    ...
    def _publish_performance(self, event):
        ...
        if self.frame_times:
            avg_fps = len(self.frame_times) / sum(self.frame_times) if sum(self.frame_times) > 0 else 0
            self.fps = avg_fps

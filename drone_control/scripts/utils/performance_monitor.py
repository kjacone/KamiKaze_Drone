#!/usr/bin/env python3
"""
drone_control/scripts/utils/performance_monitor.py
...
class PerformanceMonitor:
    ...
    def __init__(self):
        ...
        # Timers
        self.startup_monitor = rospy.Timer(rospy.Duration(2.0), self.start_monitoring)
    ...
    def collect_metrics(self, event):
        ...
        self.network_data.append({
            ...
            'packets_dropped_in': net_io.drop_in,
            'packets_dropped_out': net_io.drop_out
        })
    ...
    def collect_application_metrics(self):
        ...
        try:
            ...
            topic_stats = master.getTopicList()
            self.metrics_data['topic_count'] = len(topic_stats)
            
            # Get service statistics
            service_stats = master.getServiceList()
            self.metrics_data['service_count'] = len(service_stats)
        ...
        try:
            from rosnode import get_nodes
            self.metrics_data['ros_node_count'] = len(get_nodes())
        except Exception as e:
